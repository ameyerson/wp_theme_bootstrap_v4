...
if ( ! function_exists( 'bb_excerpt_more' ) && ! is_admin() ) {
...
if ( ! function_exists( 'get_bb_post_navigation' ) && ! is_admin() ) {

	function get_bb_post_navigation( $args = array() ) {
...
if ( ! function_exists( 'bb_post_navigation' ) && ! is_admin() ) {

	function bb_post_navigation( $args = array() ) {

		echo get_bb_post_navigation( $args );
 ...
 * 
**/
if ( ! function_exists( 'bb_post_meta' ) && ! is_admin() ) {

	function bb_post_meta( ) {
...
if ( ! function_exists( 'get_bb_breadcrumbs' ) && ! is_admin() ) {

	function get_bb_breadcrumbs( $args = array() ) {
...
if ( ! function_exists( 'bb_breadcrumbs' ) && ! is_admin() ) {

	function bb_breadcrumbs( $args = array() ) {

		echo get_bb_breadcrumbs( $args );
